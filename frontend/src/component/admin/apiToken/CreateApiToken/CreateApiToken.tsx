...
--data-raw '${JSON.stringify(getApiTokenPayload(), undefined, 2)}'`;
    ...
    return (
        <FormTemplate
            ...
            title={pageTitle}
            modal={modal}
            description='Unleash SDKs use API tokens to authenticate to the Unleash API. Backend SDKs need a backend token, which allows them to fetch feature flag configurations and post usage metrics.'
