    ...
    return (
        ...
        >
            <Alert severity={'info'} sx={{mb: theme => theme.spacing(2)}}>
                Time zone is not supported. Message about that the time is based
                on the viewer browser.
            </Alert>
            <Typography variant={'body1'} sx={{mb: theme => theme.spacing(4)}}>
                Select the date and time when these changes to be applied. You
                will be able to modify the selected time or even to apply
                directly the changes if needed.
            </Typography>
            <StyledContainer>
                <DateTimePicker
                    label='Date'
