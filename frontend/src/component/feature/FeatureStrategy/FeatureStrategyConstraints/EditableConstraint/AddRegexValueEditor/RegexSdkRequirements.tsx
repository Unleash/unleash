...
> = ({ open, onClose }) => (
    <Collapse in={open}>
        <Alert severity='info' icon={false} onClose={onClose} sx={{ mb: 2 }}>
            ...
            12.2.0, Ruby 6.5.0, Python 6.6.0, .NET 6.1.0, Go 6.2.0, Rust 0.16.0
            - or a frontend SDK connected to Unleash or Unleash Enterprise Edge
            20.1.9. Not supported in PHP.
        </Alert>
    </Collapse>
);
