...
import { alpha, Box, Paper, styled, Typography, useTheme } from '@mui/material';
import {
    Chart as ChartJS,
    CategoryScale,
    LinearScale,
...
export const PlaceholderChart: FC<PlaceholderChartProps> = ({
    ...
    const placeholderColor = alpha(theme.palette.text.disabled, 0.5);
    const placeholderFill = alpha(theme.palette.text.disabled, 0.08);
