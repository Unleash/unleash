...
interface IRolloutSliderProps {
    ...
    hideHelp?: boolean;
    /** Hide the visible title; `name` then labels the slider for a11y only. */
    hideLabel?: boolean;
    /** When to show the floating value label. Defaults to always on. */
                            ...
                            tooltip={
                                <Box>
                                    ...
                                    <Typography variant='body2'>
                                        ...
                                        proportion of users exposed to a
                                        feature. It's based on the MurmurHash of
                                        a user's unique identifier, normalized
                                        to a number between 1 and 100. If the
                                        normalized hash is less than or equal to
                                        the rollout percentage, the user sees
                                        the feature. This ensures a consistent,
                                        random distribution of the feature among
                                        users.
                                    </Typography>
                                    ...
                                    <Typography variant='body2'>
                                        ...
                                        experience. It determines the input for
                                        the MurmurHash, ensuring that a user's
                                        feature exposure remains consistent
                                        across sessions.
                                        <br />
                                        By default Unleash will use the first
                                        value present in the context in the
                                        order of{' '}
                                    ...
                                    <Typography variant='body2'>
                                        The groupId is used as a seed for the
                                        hash function, ensuring consistent
                                        feature exposure across different
                                        feature flags for a uniform user
                                        experience.
                                    </Typography>
                                </Box>
                            }
            ...
            <StyledSliderContainer>
                <SliderContent sx={{ px: hideInput ? 2.5 : 0 }}>
                    <StyledSlider
                        ...
                        aria-labelledby={
                            hideLabel ? undefined : 'discrete-slider-always'
                        }
