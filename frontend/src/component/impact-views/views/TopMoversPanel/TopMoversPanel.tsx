...
const StyledRoot = styled(Box)(({ theme }) => ({
    ...
    // Fill the slot vertically so the rail sections (goal, top movers,
...
// Row rhythm matches the Signals legend below the panel: the name on the
// left, a right-aligned figure.
...
const StyledEmpty = styled(Typography)(({ theme }) => ({
    ...
    // doesn't visually collapse to the top — keeps the rail's sections
