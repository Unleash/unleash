...
import { Table as BaseTable } from 'component/common/Table/Table/Table';
import {
    type Header,
    type Table as TableType,
    flexRender,
} from '@tanstack/react-table';
import { TableCell } from 'component/common/Table/TableCell/TableCell.tsx';
import { CellSortable } from 'component/common/Table/SortableTableHeader/CellSortable/CellSortable.tsx';
...
// Custom table with fixed layout for resizing
const ResizableTable = styled(BaseTable)({
    tableLayout: 'fixed',
    width: '100%',
});
...
/**
 * Resizable version of PaginatedTable specifically for Project Feature Toggles
 */
export const ResizablePaginatedTable = <T extends object>({
    totalItems,
    tableInstance,
}: {
    ...
    const getColumnPositions = useCallback(() => {
        ...
        return positions;
    }, [tableInstance, resizableColumnsEnabled]);
