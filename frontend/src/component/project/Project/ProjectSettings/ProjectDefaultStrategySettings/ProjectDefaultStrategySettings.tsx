...
import {PROJECT_DEFAULT_STRATEGY_READ, UPDATE_PROJECT} from 'component/providers/AccessProvider/permissions';
...
export const ProjectDefaultStrategySettings = () => {
    ...
    if (!hasAccess([UPDATE_PROJECT, PROJECT_DEFAULT_STRATEGY_READ], projectId)) {
        return (
            <PageContent
