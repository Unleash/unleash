...
export const LegacyReleasePlanTemplateAddStrategyForm = ({
    ...
    const { strategyDefinition } = useStrategy(strategy?.name || strategy?.strategyName);
    ...
    return (
        ...
        >
            <StyledHeaderBox>
                <StyledTitle>
                    {formatStrategyName(currentStrategy.name || currentStrategy.strategyName || '')}
                    {(currentStrategy.name || currentStrategy.strategyName) === 'flexibleRollout' && (
