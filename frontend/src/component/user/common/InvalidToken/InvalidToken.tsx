    ...
    return (
        ...
        >
            ...
            {passwordDisabled ? (
                ...
                <Typography variant='subtitle1'>
                    Provided invite link is invalid or expired. Please request a
                    new URL in order to create your account.
                </Typography>
            ) : (
                <>
                    <Typography variant='subtitle1'>
                        Your token has either been used to reset your password,
                        or it has expired. Please request a new reset password
                        URL in order to reset your password.
                    </Typography>
                    <Button
                        variant='contained'
                        color='primary'
