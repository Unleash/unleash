...
const useAPI = ({
    ...
    const makeRequestWithTimer = useCallback(requestWithTimer(makeRequest), [makeRequest]);
    const makeLightRequestWithTimer = useCallback(requestWithTimer(makeLightRequest), [makeLightRequest]);
