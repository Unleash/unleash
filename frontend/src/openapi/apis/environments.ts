...
export const createEnvironment = (
    createEnvironmentSchema: BodyType<CreateEnvironmentSchema>,
      ...
      {url: `/api/admin/environments`, method: 'post',
...
export const getAllEnvironments = (
      ...
      return fetcher<void>(
      {url: `/api/admin/environments`, method: 'get'
    },
      );
    }
...
export type GetAllEnvironmentsQueryResult = NonNullable<Awaited<ReturnType<typeof getAllEnvironments>>>
export type GetAllEnvironmentsQueryError = ErrorType<unknown>

export const useGetAllEnvironments = <TError = ErrorType<unknown>>(
  options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof getAllEnvironments>>, TError> & { swrKey?: Key, enabled?: boolean },  }
  ...
  const isEnabled = swrOptions?.enabled !== false
    const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getGetAllEnvironmentsKey() : null);
 ...
 */
export const validateEnvironmentName = (
    nameSchema: BodyType<NameSchema>,
 ) => {
      return fetcher<void>(
      {url: `/api/admin/environments/validate`, method: 'post',
      headers: {'Content-Type': 'application/json', },
      data: nameSchema
    },
      );
...
export const updateEnvironment = (
    ...
    updateEnvironmentSchema: BodyType<UpdateEnvironmentSchema>,
      ...
      return fetcher<EnvironmentSchema>(
      {url: `/api/admin/environments/update/${name}`, method: 'put',
      headers: {'Content-Type': 'application/json', },
...
export const removeEnvironment = (
    name: string,
      ...
      return fetcher<void>(
      {url: `/api/admin/environments/${name}`, method: 'delete'
    },
      );
    }
...
export const getEnvironment = (
    name: string,
      ...
      return fetcher<EnvironmentSchema>(
      {url: `/api/admin/environments/${name}`, method: 'get'
    },
      );
    }
  

export const getGetEnvironmentKey = (name: string,) => [`/api/admin/environments/${name}`];
...
export const useGetEnvironment = <TError = ErrorType<unknown>>(
 name: string, options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof getEnvironment>>, TError> & { swrKey?: Key, enabled?: boolean },  }
  ...
  const isEnabled = swrOptions?.enabled !== false && !!(name)
    const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getGetEnvironmentKey(name) : null);
...
export const cloneEnvironment = (
    name: string,
      ...
      return fetcher<void>(
      {url: `/api/admin/environments/${name}/clone`, method: 'post'
    },
      );
    }
...
export const getProjectEnvironments = (
    projectId: string,
      ...
      {url: `/api/admin/environments/project/${projectId}`, method: 'get'
    },
      );
    }
  

export const getGetProjectEnvironmentsKey = (projectId: string,) => [`/api/admin/environments/project/${projectId}`];

    
export type GetProjectEnvironmentsQueryResult = NonNullable<Awaited<ReturnType<typeof getProjectEnvironments>>>
...
export const useGetProjectEnvironments = <TError = ErrorType<unknown>>(
 projectId: string, options?: { swr?:SWRConfiguration<Awaited<ReturnType<typeof getProjectEnvironments>>, TError> & { swrKey?: Key, enabled?: boolean },  }
  ...
  const isEnabled = swrOptions?.enabled !== false && !!(projectId)
    const swrKey = swrOptions?.swrKey ?? (() => isEnabled ? getGetProjectEnvironmentsKey(projectId) : null);
...
export const updateSortOrder = (
    sortOrderSchema: BodyType<SortOrderSchema>,
 ) => {
      return fetcher<void>(
      {url: `/api/admin/environments/sort-order`, method: 'put',
      headers: {'Content-Type': 'application/json', },
...
export const toggleEnvironmentOn = (
    name: string,
 ) => {
      return fetcher<void>(
      {url: `/api/admin/environments/${name}/on`, method: 'post'
    },
      );
    }
  

export const toggleEnvironmentOff = (
    name: string,
 ) => {
      return fetcher<void>(
      {url: `/api/admin/environments/${name}/off`, method: 'post'
    },
      );
    }
