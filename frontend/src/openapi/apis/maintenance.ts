...
import type { ToggleMaintenanceSchema, MaintenanceSchema } from '../models';
...
>;
export type GetMaintenanceQueryError = ErrorType<void>;

export const useGetMaintenance = <TError = ErrorType<void>>(options?: {
