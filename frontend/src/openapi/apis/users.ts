...
export const getSearchUsersKey = () =>
    [`/api/admin/user-admin/search`] as const;
...
>;
export type GetAdminCountQueryError = ErrorType<unknown>;

export const useGetAdminCount = <TError = ErrorType<unknown>>(options?: {
    swr?: SWRConfiguration<
        Awaited<ReturnType<typeof getAdminCount>>,
        TError
    > & { swrKey?: Key; enabled?: boolean };
