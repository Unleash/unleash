...
/**
 * Check if a given object implements the ChangeProjectSchema interface.
 */
export function instanceOfChangeProjectSchema(value: object): boolean {
    let isInstance = true;
    isInstance = isInstance && "newProjectId" in value;
