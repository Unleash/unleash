...
/**
 * An [addon](https://docs.getunleash.io/concepts/addons) instance description. Contains data about what kind of provider it uses, whether it's enabled or not, what events it listens for, and more.
 */
