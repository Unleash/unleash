 ...
 */
import type { AdminPermissionSchema } from './adminPermissionSchema.ts';
import type { AdminPermissionsSchemaPermissionsEnvironmentsItem } from './adminPermissionsSchemaPermissionsEnvironmentsItem.ts';
