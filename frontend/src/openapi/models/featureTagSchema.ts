...
export interface FeatureTagSchema {
    ...
    featureName: string;
    /** The [type](https://docs.getunleash.io/reference/feature-flags#tags tag types) of the tag */
    tagType?: string;
    /** The value of the tag */
    tagValue: string;
    /**
     * The [type](https://docs.getunleash.io/reference/feature-flags#tags tag types) of the tag. This property is deprecated and will be removed in a future version of Unleash. Superseded by the `tagType` property.
     * @deprecated
     */
    type?: string;
    /**
