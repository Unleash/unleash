 ...
 */
import type { OidcSettingsSchemaOneOfFourDefaultRootRole } from './oidcSettingsSchemaOneOfFourDefaultRootRole.ts';
import type { OidcSettingsSchemaOneOfFourIdTokenSigningAlgorithm } from './oidcSettingsSchemaOneOfFourIdTokenSigningAlgorithm.ts';
