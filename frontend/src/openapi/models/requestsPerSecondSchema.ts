 ...
 */
import type { RequestsPerSecondSchemaData } from './requestsPerSecondSchemaData.ts';
import type { RequestsPerSecondSchemaStatus } from './requestsPerSecondSchemaStatus.ts';
