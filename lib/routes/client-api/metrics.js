...
class ClientMetricsController extends Controller {
    constructor({ clientMetricsEventStore, clientInstanceStore }, getLogger) {
        super();
        this.logger = getLogger('/api/client/metrics');
        this.clientMetricsEventStore = clientMetricsEventStore;
    ...
    async registerMetrics(req, res) {
        ...
        try {
            await this.clientMetricsEventStore.insert(value);
