...
import { ProjectJsonSchemaStore } from '../features/project-json-schemas/project-json-schema-store.js';
...
export const createStores = (
    ...
    return {
        ...
        projectJsonSchemaStore: new ProjectJsonSchemaStore(db, config),
    };
};
