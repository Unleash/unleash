...
export const featureFeedbackSchema = {
    $id: '#/components/schemas/featureFeedbackSchema',
    type: 'object',
...
export type FeatureFeedbackSchema = FromSchema<typeof featureFeedbackSchema>;
