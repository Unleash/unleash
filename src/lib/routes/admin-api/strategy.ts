        ...
        this.route({
            ...
            middleware: [
                openApiService.validPath({
                    ...
                    description:
                        'Retrieves all strategy types ([predefined](https://docs.getunleash.io/reference/activation-strategies "predefined strategies") and [custom strategies](https://docs.getunleash.io/reference/activation-strategies#custom-strategiess)) that are defined on this Unleash instance.',
                    tags: ['Strategies'],
