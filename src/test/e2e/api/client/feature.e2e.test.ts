...
describe('Feature flag naming pattern', () => {
    test('Uses a feature flag naming pattern to validate feature names', async () => {
        ...
        const passingName1 = '123.ABCDE';
        const passingName2 = '123.abc';
        const failingName = '123.abcdefghijklmnop';
    ...
    test('Returns the pattern and the example in the response when it fails', async () => {
        // fix this
    });
});
