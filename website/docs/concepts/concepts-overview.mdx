...
By default, a [feature flag](/concepts/feature-flags) in Unleash only tells you whether a feature is enabled or disabled, but you can also add more information to your flags by using [**variants**](/concepts/strategy-variants). Variants also allow you to run [A/B testing experiments](/guides/a-b-testing).
