...
| **Editor** | Root    | Users with the root editor role have access to most features in Unleash, but they cannot manage users and roles in the root scope. Editors are project owners for projects they create and get superuser rights within the context of those projects. Users with the editor role will also get access to most permissions on the default project by default. | All versions       |
