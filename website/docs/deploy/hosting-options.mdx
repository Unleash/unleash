...
If you are currently self-hosting [Proxy](/reference/unleash-proxy), see our [Edge migration guide](https://github.com/Unleash/unleash-edge/blob/main/docs/migration-guide) for a guide on how to migrate.
