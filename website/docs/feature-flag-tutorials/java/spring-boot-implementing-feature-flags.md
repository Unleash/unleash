...
Continue on to our [Spring Boot examples documentation](/feature-flag-tutorials/java/spring-boot-examples) for more advanced use cases of feature flags in Java Spring Boot using the Spring PetClinic app!
