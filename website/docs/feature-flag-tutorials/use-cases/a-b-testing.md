...
For multivariate testing, there can be multiple combinations of features to test. We recommend you create a flag for each feature and as many variants as required by each feature. With the user context that your SDK will record in your app, send it to the analytics platform and see how it converts.
