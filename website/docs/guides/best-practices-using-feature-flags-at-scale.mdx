...
[Feature flags are temporary and dynamic]((/what-is-a-feature-flag). They give you [runtime control]/guidesfeature-flag-best-practices#1-enable-runtime-control) to enable or disable functionality in a live environment—perfect for things like [short-lived experiments]/guidesfeature-flag-best-practices#2-make-flags-short-lived), such as A/B testing or gradual rollouts.
...
This is why feature flag systems should be [open by default]/guidesfeature-flag-best-practices#5-choose-open-by-default).
...
This guide focused on using [feature flags at scale](https://www.getunleash.io/blog/feature-management). For advice on building and scaling the flag system itself, check out our [feature flag best practices guide]/guidesfeature-flag-best-practices).
