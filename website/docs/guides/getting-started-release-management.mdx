...
[Release templates](/concepts/release-templates) help you standardize your rollout process. Instead of manually configuring [strategies](/concepts/activation-stratgies), you can apply a predefined sequence of [milestones](/concepts/release-templates#milestone).
