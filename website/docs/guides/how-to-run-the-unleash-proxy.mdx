...
The Unleash Proxy provides a way for you to consume feature flags in [front-end clients](/reference/sdks#frontend-sdks), such as the [JavaScript Proxy client](/reference/sdks/javascript-browser) and [React Proxy client](/reference/sdks/react).
