...
The Unleash Proxy provides a way for you to consume feature flags in [front-end clients](/sdks#frontend-sdks), such as the [JavaScript Proxy client](/sdks/javascript-browser) and [React Proxy client](/sdks/react).
