...
On the form, you also have the option to either generate an API token at a later stage or right away. If you choose to generate an API token right away, you will be able to select the token access, and once you submit the form a new server-side SDK (CLIENT) token will be generated for you.
