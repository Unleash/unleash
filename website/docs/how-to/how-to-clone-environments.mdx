...
Select an environment type and select which projects should have their environment configuration cloned. Choose whether to keep the existing user permissions for the new environment or to make it a fresh environment where only an admin or editor of the selected projects can make changes.
