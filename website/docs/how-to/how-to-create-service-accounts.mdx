...
Navigate to the _Service accounts_ page in the admin UI (available at the URL `/admin/service-accounts`). Use the "Settings Wheel" on the navigation menu and select "Service accounts".

![The admin UI navigation "Settings Wheel" submenu with the Service accounts item highlighted.](/img/service-accounts-1.png)

## Step 2: Click the "new service account" button {#step-2}

On the top right corner, use the "new service account" button to open the "new service account" form.

![The "service accounts" table with the "new service account" button highlighted.](/img/service-accounts-2.png)
