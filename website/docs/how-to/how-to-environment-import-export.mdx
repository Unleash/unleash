...
* [activation strategies](/reference/activation-strategies) including [constraints](/reference/strategy-constraints) and references to [segments](/reference/segments)
...
* [feature tag types](/reference/tags#tag-types)
