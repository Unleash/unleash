...
The [Unleash Proxy](../generated/unleash-proxy) provides a way for you to consume feature flags in [front-end clients](../reference/sdks/index#front-end-sdks), such as the [JavaScript Proxy client](/docs/generated/sdks/client-side/javascript-browser) and [React Proxy client](/docs/generated/sdks/client-side/react).
...
When running the Proxy, you'll need to provide it with at least the configuration options listed below. Check the reference docs for the [full list of configuration options](../generated/unleash-proxy#configuration-options).
...
Import the `createApp` function from `@unleash/proxy` and configure the proxy. You'll need to provide at least the configuration options highlighted below. Check the reference docs for the [full list of configuration options](../generated/unleash-proxy#configuration-options).
