...
At Unleash, we prioritize the privacy and security of our customers' data. Our [architecture](/concepts/core-concepts) ensures privacy by evaluating feature flags locally within the [client SDKs](/sdks) or [Unleash Edge](/unleash-edge), meaning no user data is shared with the Unleash instance.
