...
Use frontend tokens for connecting [frontend SDKs](/reference/sdks#frontend-sdks) to Unleash using the [Unleash Frontend API](/api) or [Unleash Edge](/reference/unleash-edge). They grant the user permission to:
