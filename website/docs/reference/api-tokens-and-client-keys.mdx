...
Personal API tokens do not contain project or environment information, since they mimic the user that created them. Instead, the token starts with the string `user`.
