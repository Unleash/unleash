...
Unleash uses API keys to facilitate communication between consuming clients such as [SDKs](/sdks), [Unleash Edge](/reference/unleash-edge), or other tools and automation.

Unleash supports the following types of API tokens:
- [Backend tokens](#backend-tokens) for connecting [backend SDKs](/sdks#backend-sdks) or [Unleash Edge](/reference/unleash-edge) to Unleash.
- [Frontend tokens](#frontend-tokens) for connecting [frontend SDKs](/sdks#frontend-sdks) to Unleash using the [Frontend API](/reference/front-end-api) or [Unleash Edge](/reference/unleash-edge).
...
Backend tokens are intended for use in [backend SDKs](/sdks#backend-sdks) or [Unleash Edge](/reference/unleash-edge) to grant the permissions to:
...
Use frontend tokens for connecting [frontend SDKs](/sdks#frontend-sdks) to Unleash using the [Unleash Frontend API](/api) or [Unleash Edge](/reference/unleash-edge). They grant the user permission to:
