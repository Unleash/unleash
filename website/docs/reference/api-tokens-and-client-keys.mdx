...
- [Backend tokens](#backend-tokens) for connecting [backend SDKs](/reference/sdks#backend-sdks) or [Unleash Edge](/reference/unleash-edge) to Unleash.
...
Backend tokens are intended for use in [backend SDKs](/reference/sdks#backend-sdks) or [Unleash Edge](/reference/unleash-edge) to grant the permissions to:
...
Use frontend tokens for connecting [frontend SDKs](/reference/sdks#frontend-sdks) to Unleash using the [Unleash Frontend API](/get-started/api-overview) or [Unleash Edge](/reference/unleash-edge). They grant the user permission to:
...
You can use proxy client keys to connect [frontend SDKs](/reference/sdks#frontend-sdks) to Unleash Proxy. Proxy client keys are not considered a secret and are safe to expose client-side.
