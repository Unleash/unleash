...
To use the admin API, you'll need to [create and use an admin API token](/how-to/how-to-create-api-tokensx).

:::

The segments API lets you create, read, update, and delete [segments](/reference/segmentsx).
