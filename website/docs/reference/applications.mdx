...
An **application** is any service that sends requests to the [Unleash Client API](/get-started/api-overview), the [Unleash Frontend API](/get-started/api-overview), the Unleash Admin API, or any other API that Unleash exposes. This includes [Unleash SDKs](/reference/sdks), [Unleash Edge](/reference/unleash-edge), the [Unleash proxy](/reference/unleash-proxy), and even the Admin UI.
