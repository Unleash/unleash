...
An **application** is any service that sends requests to the [Unleash Client API](/reference/api/unleash/client), the [Unleash Frontend API](front-end-api), the Unleash Admin API, or any other API that Unleash exposes. This includes [Unleash SDKs](./sdks/index), [Unleash Edge](/docs/generated/unleash-edge), the [Unleash proxy](/docs/generated/unleash-proxy), and even the Admin UI.
