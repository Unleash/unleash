...
Custom activation strategies should be considered an advanced feature because in most cases [strategy constraints](https://docs.getunleash.io/reference/strategy-constraints) provides enough control without the additional complexity.
