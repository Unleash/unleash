...
![Feature lifecycle example](/img/archive-feature-flag.png)
...
You can delete archived flags by navigating to the [feature flag archive](#view-archived-flags) and clicking **Delete feature flag**. Don't delete any feature flags unless you are certain that it is no longer in use, and its name can be safely reused.
