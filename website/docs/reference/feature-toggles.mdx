...
To view archived feature flags in a project, click **View archived flags**.
 ...
 archived feature flags inside **Flags overview**, click **Archived flags**.

### Revive a feature flag

Revived flags are in an inactive state by default.

To revive an archived flag inside a project:

1. Open the project and click **View archived flags** .
2. Find the flag you want to delete and click **Revive feature flag**. 
...
To delete an archived flag inside a project:
