...
In addition the actual Unleash context, the playground also needs to know about environments and projects. In addition to the Unleash context, you must also select an environment and one or more projects for the query.
