...
| Default Strategy   | The [project default strategy](/reference/project-collaboration-mode.md) for the project. This setting controls the default strategy that will be added when you turn a feature environment toggle on (only if the environments has no defined strategies.                 |
