...
Unleash supports predefined and custom roles at the project levels. The two predefined roles are Owner and Member. By default, the person creating the project becomes the Owner. If a project does not have an owner, it is shown as owned by _System_.
