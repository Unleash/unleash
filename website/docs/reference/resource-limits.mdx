...
The resources and their respective limits are:
...
With two exceptions, all the limits can be overridden through the use of their respective environment variables. However, while it is possible to override these limits, we advise against it in most cases. If you feel that you're unable to do what you need to do because of the limits, we'd love to hear from you.
...
The only limits that can't be changed, are the limits for projects and environments for OSS instances.
