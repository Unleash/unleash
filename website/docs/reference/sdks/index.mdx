...
- **Format**: The language/framework followed by a colon and the semantic version of the SDK. For example, `unleash-client-java@10.0.1` or `unleash-client-node@6.4.4`.  
