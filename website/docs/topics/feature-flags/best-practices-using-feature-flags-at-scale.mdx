...
![Evaluate flags once](/img/evaluate-flag-many-places.jpg)
...
Your flag system should integrate with your [single sign-on](../../reference/sso) (SSO) provider. That way, when a user is added to or removed from a group in your central directory, their access to the [flag system updates automatically](../../reference/provisioning).
