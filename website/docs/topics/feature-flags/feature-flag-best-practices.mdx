...
3. [Make flags short-lived](#2-make-flags-short-lived)
2. [Prioritize availability over consistency](#3-prioritize-availability-over-consistency)
...
[![Video display SDKs](/img/sdk-video-display.png)](https://www.youtube.com/embed/mCXSAWzdn3I)
...
[![What are feature flags video display](/img/what-are-ff-video-display.png)](https://www.youtube.com/embed/_kYAQsuTtqQ?si=tbMDZOyiZSILW70H)
...
[![Edge video display](/img/edge-video-display.png)](https://www.youtube.com/embed/6uIdF-yByWs?si=kk5OGb-1nVfea06B)
