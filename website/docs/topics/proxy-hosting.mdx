...
:::tip Looking for how to run the Unleash proxy? Check out the [_How to run the Unleash Proxy_ guide](../how-to/how-to-run-the-unleash-proxy.mdx)! :::
...
:::info You **must configure** these three variables for the proxy to start successfully:
...
:::info Availability The OpenAPI integration is available in versions 0.9 and later of the Unleash proxy. :::
