...
![An architecture diagram of Enterprise Edge](/img/unleash-hosts-everything.png)
...
### Unleash Enterprise Edge vs self-hosted Edge

| Feature                 | Unleash Enterprise Edge                                                       | Self-hosted Unleash Edge                                                                                    |
| :---------------------- | :------------------------------------------------------------------------------------------- | :---------------------------------------------------------------------------------------------------------- |
...
| **Control and flexibility**| Lower direct control over the underlying infrastructure                 | Full control over deployment environment, location, network configuration, and resource allocation |
...
| **Observability** | Provided by Unleash (monitoring, logging)                                                   | You need to set up and manage your own monitoring and logging solutions for Edge  |
| **Deployment location** | Available in [11 global regions](#cloud-hosted-unleash-edge) | Deploy within your own infrastructure, VPC, or on-premises, wherever you can run containers |
| **Latency optimization**| Automatically connect SDKs to the nearest available Unleash-managed region                  | Deploy Edge instances geographically close to your applications within your network        |
| *Client-side context processing (may include PII)** | Processed on Unleash-managed Edge infrastructure, but does not reach the central Unleash server or database. | Processed entirely within your infrastructure. PII does not leave your network boundary. |
...
![An architecture diagram of using Edge in a setup where Unleash hosts the API and you host the Edge.](/img/you-host-edge.png)
...
![An architecture diagram of using the Edge in a single-region, self-hosted setup.](/img/you-host-everything.png)
...
![An architecture diagram of using the proxy in a multi-region, self-hosted setup.](/img/you-host-everything-multi-region.png)
