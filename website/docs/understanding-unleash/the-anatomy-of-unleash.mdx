...
A release template is a blueprint for a rollout. It consists of sequential stages called milestones. Each milestone contains one or more activation strategies. For example, a template might look like this:
