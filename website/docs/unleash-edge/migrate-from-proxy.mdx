...
If you migrating to Enterprise Edge hosted, you do not need to deploy any infrastructure.
...
Edge dynamically routes requests to the correct [environment](/concepts/environments) based on the API token provided by the SDK.
