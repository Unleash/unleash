...
[Personal access tokens](../reference/api-tokens-and-client-keys.mdx#personal-access-tokens) enable a user to use the Unleash admin API as themselves instead of as an global "admin" user.
