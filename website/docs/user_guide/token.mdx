...
<div style={{ flexShrink: 1, flexGrow: 1, flexBasis: 0, minWidth: '300px' }}>
...
- 3.2.B. **FRONTEND**<br/>
New in _Unleash v14.15_. Select this option if you'd like to connect client-side SDK directly, without setting up Proxy.
<!-- FIXME: version -->
...
<!-- FIXME: link to admin api docs
Everything you see in the UI can be automated with an API call, and we [up-to-date API documentation](TODO). -->
