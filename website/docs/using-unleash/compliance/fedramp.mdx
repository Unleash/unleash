...
When operating in a [FedRAMP](https://www.fedramp.gov/program-basics/) compliant environment, you must ensure that any additional system you introduce is also FedRAMP compliant. Using software that does not meet these requirements can create vulnerabilities and affect your compliance strategy. 
...
| [CM-05 Access Restrictions for Change](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_0/home?element=CM-5) | Unleash provides advanced [role-based access control](/reference/rbac) (RBAC) controls to implement logical access restrictions. [Change Request](/reference/change-requests) help you define and track approval flows. |
...
| **FedRAMP Control**                                                                                   | **Unleash Features**                                                                                                         |
|-------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------|
| [SC-08 (01) Transmission Confidentiality and Integrity](https://csrc.nist.gov/projects/cprt/catalog#/cprt/framework/version/SP_800_53_5_1_0/home?element=SC-8) (Cryptographic Protection) | Unleash implements cryptographic protection for data in transit, as detailed in our SOC2 report (available upon [request](mailto:sales@getunleash.io)). |
