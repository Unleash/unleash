...
**Plan**: [Enterprise](https://www.getunleash.io/pricing) | **Version**: `5.8+`

:::

Unleash Enterprise uses license keys to ensure you comply with the terms of your contract. For hosted versions of Unleash, license management is handled automatically. If you self-host Unleash Enterprise, you must manage your license key.
...
You can also install or update your license key on container deployment, using the environment variable `UNLEASH_LICENSE`.
